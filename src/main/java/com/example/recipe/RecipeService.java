...
public class RecipeService implements RecipeRepository {
       ...
       public ArrayList<Recipe> getRecipe(){
        Collection<Recipe> recipeCollections=recipeBook.values();
        ArrayList<Recipe> recipe= new ArrayList<>(recipeCollections);
        return recipe;
       }
       @Override
       ...
       public Recipe updateRecipe(int recipeId,Recipe recipe){
        ...
        if(recipe.getRecipeName() != null){
         ...
         if(recipe.getIngredients() != null){
                existingRecipe.setIngridents(recipe.getIngredients());
        }
